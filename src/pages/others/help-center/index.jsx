...
const metadata = {
  title: "Help Center - Key Car Rental Iceland",
  description: "Do you have any questions? Here you can find the answers!",
};
            ...
            <div className="col-xl-6 col-lg-8 col-md-10">
              <div className="sectionTitle -md">
                ...
                <p className=" sectionTitle__text mt-5 sm:mt-0">
                  Find answers to your questions about renting a car in Iceland
                </p>
              </div>
              {/* End .sectiontitle */}
