    ...
    <>
      <section className="masthead -type-8">
        <div className="masthead__bg">
          <img
            src="/img/masthead/8/bg-white.jpg"
            alt="image"
            ...
            <div className="col-xl-10">
              <div className="text-center">
                <h1
                  ...
                  data-aos-delay="100"
                >
                  Explore <span className="brand">Iceland</span> with Key Car Rental
                </h1>
                <p
                  ...
                  data-aos-delay="200"
                >
                  Start Your Icelandic Adventure with Key Car Rental at Keflavík Airport!
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className="masthead-slider overflow-hidden js-masthead-slider-8">
            ...
            >
              <SwiperSlide>
                <img src="/img/masthead/8/backround-1.png" alt="image" />
              </SwiperSlide>
            </Swiper>
