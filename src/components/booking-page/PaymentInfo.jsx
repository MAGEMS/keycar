...
const PaymentInfo = ({totalPaymentAmount = 0, activeInsurenceTotalPrice = 0, activeExtrasTotalPrice = 0}) => {
      ...
      <div className="col-xl-5 col-lg-4">
        <div className="booking-sidebar">
          <PricingSummary 
            ...
            Insurence={activeInsurenceTotalPrice}
            Extras={activeExtrasTotalPrice}
          />
          {/* <PaymentSchedule /> */}
          <PromoCode />
        </div>
